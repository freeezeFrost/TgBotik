...
MIN_VOICE_DURATION_SECONDS = get_positive_int_env("MIN_VOICE_DURATION_SECONDS", default=2)
MAX_VOICE_DURATION_SECONDS = get_positive_int_env("MAX_VOICE_DURATION_SECONDS", default=180)
MAX_VIDEO_NOTE_DURATION_SECONDS = get_positive_int_env("MAX_VIDEO_NOTE_DURATION_SECONDS", default=180)
